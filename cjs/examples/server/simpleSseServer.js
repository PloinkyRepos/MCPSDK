...
const getServer = () => {
  ...
  server.tool(
    ...
    {
      interval: zod.z.number().describe("Interval in milliseconds between notifications").default(1e3),
      count: zod.z.number().describe("Number of notifications to send").default(10)
    },
